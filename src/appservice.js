...
const appService = {
  ...
  sendemail (userdata) {
    ...
    return new Promise((resolve, reject) => {
      axios.post('https://api.sendgrid.com/v3/mail/send', JSON.stringify(userdata),
        {
          headers: {
            'Authorization': 'Bearer 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',
